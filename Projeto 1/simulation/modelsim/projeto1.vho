...
-- Design Ports Information
-- ab	=>  Location: PIN_100,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst4~1_combout\ = (\b[1]~input_o\ & ((\a[3]~input_o\ $ (\b[3]~input_o\)) # (!\a[1]~input_o\))) # (!\b[1]~input_o\ & ((\a[1]~input_o\) # (\a[3]~input_o\ $ (\b[3]~input_o\))))
...
-- Equation(s):
-- \inst4~0_combout\ = (\a[0]~input_o\ & ((\a[2]~input_o\ $ (\b[2]~input_o\)) # (!\b[0]~input_o\))) # (!\a[0]~input_o\ & ((\b[0]~input_o\) # (\a[2]~input_o\ $ (\b[2]~input_o\))))
